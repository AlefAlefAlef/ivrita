...
export default [
  ...
  [`(${W})${SEP}ה${B}`, '$1', '$1ה'], // בגללו/ה
  [`(${W})ה${SEP}תה${B}`, '$1ה', '$1תה'], // בכה/תה
  ...
  [`(${W})${SEP}י${B}`, '$1', 'י$1י'], // הקשב/י
  [`(${W})(ה)?${SEP}ת${B}`, '$1$2', '$1ת'], // נהג/ת, רואה/ת חשבון
  [`(${W})ם${SEP}?ן${B}`, '$1ם', '$1ן'], // אתם/ן
  [`(${W})ן${SEP}?ם${B}`, '$1ם', '$1ן'], // אתן/ם
  [`(${W}+)ו${SEP}ת(${W}+)נה`, '$1ו', 'ת$2נה'], // צאו/תצאנה
  [`(${W})${SEP}נה${B}`, '$1', '$1נה'], // צאו/נה
